...
import spring.study.redis.pubsub.RedisPublisher;
import spring.study.redis.pubsub.RedisSubscriber;
import spring.study.redis.pubsub.RoomMessage;
...
public class PubSubController {
    ...
    public void pushMessage(@PathVariable String roomId,@RequestParam String name, @RequestParam String message){
        ...
        redisPublisher.publish(channel, RoomMessage.builder().roomId(roomId).name(name).message(message).build());
    }
